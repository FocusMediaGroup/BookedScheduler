=======================
Setting up the Saml Authentication plugin for FMG Scheduler version 2.4
=======================
Changes:
...
Install SAML 2.0 Service Provider on the same server where FMG Scheduler
...
2) In the FMG Scheduler ROOT_DIRECTORY/config/config.php file,
