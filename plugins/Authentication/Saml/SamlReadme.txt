=======================
Setting up the Saml Authentication plugin for Hospitality Signage Platform version 2.4
=======================
Changes:
...
Install SAML 2.0 Service Provider on the same server where Hospitality Signage Platform
...
2) In the Hospitality Signage Platform ROOT_DIRECTORY/config/config.php file,
