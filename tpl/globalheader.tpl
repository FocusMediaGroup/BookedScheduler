                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown" id="navHelpDropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">{translate key="Help"} <b
                                    class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li id="navHelp"><a href="https://www.fmgegypt.com/help/usage">{translate key=Help}</a></li>
                            {if $CanViewAdmin}
                                <li id="navHelpAdmin"><a href="https://www.fmgegypt.com/help/administration">{translate key=Administration}</a></li>
                            {/if}
