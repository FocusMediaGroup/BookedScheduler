{include file='globalheader.tpl' Title='Hospitality Signage Platform v2 Migration'}

<h1>Migrate phpScheduleIt v1.2 to Hospitality Signage Platform v2.x (MySQL only)</h1>
	...
	{else}
		...
		<div class="error">
			...
			<ul style="margin-left: 30px;">
				...
				<li>At the time of writing, Hospitality Signage Platform 2 is not available in all of the same languages that 1.2 was.
