# Welcome to Hospitality Signage Platform

This is a community effort to keep the OpenSource [GPLv3](./LICENSE.md) HSP alive, see [History](./doc/HISTORY.md)
...
## REPO
<https://github.com/FocusMediaGroup/HSP>

## Chat
We now have a chatroom on Gitter.im, join us at: <https://gitter.im/hsp>
...
Based on the original open source version of Booked, now available at: [https://github.com/FocusMediaGroup/HSP](https://github.com/FocusMediaGroup/HSP)  
Fork this repo, contribute and help keep it alive

Way too many changes, bugfixes and improvements to list them all here, so please take a look at: https://github.com/FocusMediaGroup/HSP/commits/master
...
**This version is no longer developed by Twinkle Toes Software (<https://www.fmgegypt.com>)**
Based on the original open source version of Booked, now available at: [https://github.com/FocusMediaGroup/HSP](<https://github.com/FocusMediaGroup/HSP>)<br>
...
- Application renamed from phpScheduleIt to Hospitality Signage Platform [(why?)](http://www.fmgegypt.com/phpscheduleit)
