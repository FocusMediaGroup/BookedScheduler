...
class pt_br extends en_gb
{
    ...
    */
    protected function _LoadStrings()
    {
        ...
        // Install
        $strings['InstallApplication'] = 'Instalar FMG Scheduler (apenas para MySQL)';
        ...
        $strings['NoUpgradeNeeded'] = 'Não existe necessidade de atualização. Executar o processo de instalação irá deletar todos os dados existentes e instalar uma nova cópia do FMG Scheduler!';
        ...
        $strings['InstalledVersion'] = 'Você está executando a versão %s do FMG Scheduler';
        ...
        $strings['ConfigureApplication'] = 'Configurar FMG Scheduler';
