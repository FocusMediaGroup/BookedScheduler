...
class pt_br extends en_gb
{
    ...
    */
    protected function _LoadStrings()
    {
        ...
        // Install
        $strings['InstallApplication'] = 'Instalar Hospitality Signage Platform (apenas para MySQL)';
        ...
        $strings['NoUpgradeNeeded'] = 'Não existe necessidade de atualização. Executar o processo de instalação irá deletar todos os dados existentes e instalar uma nova cópia do Hospitality Signage Platform!';
        ...
        $strings['InstalledVersion'] = 'Você está executando a versão %s do Hospitality Signage Platform';
        ...
        $strings['ConfigureApplication'] = 'Configurar Hospitality Signage Platform';
