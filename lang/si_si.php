...
class si_si extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        // Install
        $strings['InstallApplication'] = 'Namesti program Hospitality Signage Platform (samo MySQL)';
        ...
        $strings['NoUpgradeNeeded'] = 'Nadgradnja ni potrebna. Ko boste pognali namestitveni proces, se bodo zbrisali vsi obstoječi podatki in namestila se bo nova kopija programa Hospitality Signage Platform!';
        ...
        $strings['InstalledVersion'] = 'Trenutno teče različica %s programa Hospitality Signage Platform';
        ...
        $strings['ConfigureApplication'] = 'Konfiguracija programa Hospitality Signage Platform';
