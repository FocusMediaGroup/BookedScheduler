...
class si_si extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        // Install
        $strings['InstallApplication'] = 'Namesti program FMG Scheduler (samo MySQL)';
        ...
        $strings['NoUpgradeNeeded'] = 'Nadgradnja ni potrebna. Ko boste pognali namestitveni proces, se bodo zbrisali vsi obstoječi podatki in namestila se bo nova kopija programa FMG Scheduler!';
        ...
        $strings['InstalledVersion'] = 'Trenutno teče različica %s programa FMG Scheduler';
        ...
        $strings['ConfigureApplication'] = 'Konfiguracija programa FMG Scheduler';
