...
class ee_ee extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        $strings['NoUpgradeNeeded'] = 'There is no upgrade needed. Running the installation process will delete all existing data and install a new copy of Hospitality Signage Platform!';
