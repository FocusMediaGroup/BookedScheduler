...
class id_id extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        // Install
        $strings['InstallApplication'] = 'Pasang Hospitality Signage Platform (hanya MySQL)';
        ...
        $strings['NoUpgradeNeeded'] = 'Tidak perlu pembaruan. Jalankan proses pemasangan akan menghapus semua dara yang ada dan memasang salinan baru Hospitality Signage Platform!';
        ...
        $strings['InstalledVersion'] = 'Anda sekarang menjalankan versi %s dari Hospitality Signage Platform';
        ...
        $strings['ConfigureApplication'] = 'Pengaturan Hospitality Signage Platform';
    ...
    protected function _LoadDays()
    {
         ...
         ***/
        // The full day name
        $days['full'] = ['Minggu', 'Senin', 'Selasa', 'Rabu', 'Kamis', 'Jum\'at', 'Sabtu'];
        // The three letter abbreviation
        $days['abbr'] = ['Min', 'Sen', 'Sel', 'Rab', 'Kam', 'Jum', 'Sab'];
        // The two letter abbreviation
        $days['two'] = ['Mi', 'Se', 'Se', 'Ra', 'Ka', 'Ju', 'Sa'];
    ...
    protected function _LoadMonths()
    {
         ...
         ***/
        // The full month name
        $months['full'] = ['Januari', 'Pebruari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September', 'Oktober', 'Nopember', 'Desember'];
