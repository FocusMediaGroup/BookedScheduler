...
class id_id extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        // Install
        $strings['InstallApplication'] = 'Pasang FMG Scheduler (hanya MySQL)';
        ...
        $strings['NoUpgradeNeeded'] = 'Tidak perlu pembaruan. Jalankan proses pemasangan akan menghapus semua dara yang ada dan memasang salinan baru FMG Scheduler!';
        ...
        $strings['InstalledVersion'] = 'Anda sekarang menjalankan versi %s dari FMG Scheduler';
        ...
        $strings['ConfigureApplication'] = 'Pengaturan FMG Scheduler';
