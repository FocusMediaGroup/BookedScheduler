...
class tr_tr extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        // Install
        $strings['InstallApplication'] = 'Install Hospitality Signage Platform (MySQL only)';
        ...
        $strings['InstalledVersion'] = 'You are now running version %s of Hospitality Signage Platform';
        ...
        $strings['ConfigureApplication'] = 'Configure Hospitality Signage Platform';
    ...
    protected function _LoadDays()
    {
         ...
         ***/
        // The full day name
        $days['full'] = ['Pazar', 'Pazartesi', 'Salı', 'Çarşamba', 'Perşembe', 'Cuma', 'Cumartesi'];
        // The three letter abbreviation
        $days['abbr'] = ['Pzr', 'Pts', 'Sal', 'Çar', 'Per', 'Cum', 'Cts'];
        // The two letter abbreviation
        $days['two'] = ['Pz', 'Pt', 'Sa', 'Ça', 'Pe', 'Cu', 'Ct'];
    ...
    protected function _LoadMonths()
    {
         ...
         ***/
        // The full month name
        $months['full'] = ['Ocak', 'Şubat', 'Mart', 'Nisan', 'Mayıs', 'Haziran', 'Temmuz', 'Ağustos', 'Eylül', 'Ekim', 'Kasım', 'Aralık'];
