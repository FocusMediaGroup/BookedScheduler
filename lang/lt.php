...
class lt extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        // Install
        $strings['InstallApplication'] = 'Diegti Hospitality Signage Platform (tik su MySQL)';
        ...
        $strings['NoUpgradeNeeded'] = 'Atnaujinimas neb�tinas. Leid�iant diegim� bus i�trinta visi esami duomenys ir �diegta nauja Hospitality Signage Platform kopija!';
        ...
        $strings['InstalledVersion'] = 'Naudojat�s Hospitality Signage Platform, versija %s ';
        ...
        $strings['ConfigureApplication'] = 'Nustatyti Hospitality Signage Platform';
    ...
    protected function _LoadDays()
    {
         ...
         ***/
        // The full day name
        $days['full'] = ['Sekmadienis', 'Pirmadienis', 'Antradienis', 'Tre�iadienis', 'Ketvirtadienis', 'Penktadienis', '�e�tadienis'];
        // The three letter abbreviation
        $days['abbr'] = ['Sek', 'Pir', 'Ant', 'Tre', 'Ket', 'Pen', '�e�'];
        // The two letter abbreviation
        $days['two'] = ['Sk', 'Pr', 'An', 'Tr', 'Kt', 'Pn', '�t'];
        // The one letter abbreviation
        $days['letter'] = ['S', 'P', 'A', 'T', 'K', 'P', '�'];
    ...
    protected function _LoadMonths()
    {
         ...
         ***/
        // The full month name
        $months['full'] = ['Sausis', 'Vasaris', 'Kovas', 'Balandis', 'Gegu��', 'Bir�elis', 'Liepa', 'Rugpj�tis', 'Rugs�jis', 'Spalis', 'Lapkritis', 'Gruodis'];
