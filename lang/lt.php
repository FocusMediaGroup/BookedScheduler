...
class lt extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        // Install
        $strings['InstallApplication'] = 'Diegti FMG Scheduler (tik su MySQL)';
        ...
        $strings['NoUpgradeNeeded'] = 'Atnaujinimas neb�tinas. Leid�iant diegim� bus i�trinta visi esami duomenys ir �diegta nauja FMG Scheduler kopija!';
        ...
        $strings['InstalledVersion'] = 'Naudojat�s FMG Scheduler, versija %s ';
        ...
        $strings['ConfigureApplication'] = 'Nustatyti FMG Scheduler';
