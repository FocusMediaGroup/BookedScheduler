...
class no_no extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        // Install
        $strings['InstallApplication'] = 'Installer Hospitality Signage Platform (kun MySQL)';
        ...
        $strings['NoUpgradeNeeded'] = 'Ingen oppdatering nødvendig. Ved å kjøre en ny innstallasjon vil alle eksisterende data bli slettet og en ny kopi av Hospitality Signage Platform vil bli innstallert!';
        ...
        $strings['InstalledVersion'] = 'Du kjører nå versjon %s av Hospitality Signage Platform';
        ...
        $strings['ConfigureApplication'] = 'Konfigurer Hospitality Signage Platform';
