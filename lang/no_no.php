...
class no_no extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        // Install
        $strings['InstallApplication'] = 'Installer FMG Scheduler (kun MySQL)';
        ...
        $strings['NoUpgradeNeeded'] = 'Ingen oppdatering nødvendig. Ved å kjøre en ny innstallasjon vil alle eksisterende data bli slettet og en ny kopi av FMG Scheduler vil bli innstallert!';
        ...
        $strings['InstalledVersion'] = 'Du kjører nå versjon %s av FMG Scheduler';
