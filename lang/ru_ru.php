...
class ru_ru extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        // Install
        $strings['InstallApplication'] = 'Установка Hospitality Signage Platform (только MySQL)';
        ...
        $strings['NoUpgradeNeeded'] = 'Нет необходимости обновления. Запуск процесса установки удалит все существующие данные и установить новую копию Hospitality Signage Platform!';
        ...
        $strings['InstalledVersion'] = 'Сейчас у вас запущена версия %s Hospitality Signage Platform';
        ...
        $strings['ConfigureApplication'] = 'Настроить Hospitality Signage Platform';
