...
class ru_ru extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        // Install
        $strings['InstallApplication'] = 'Установка FMG Scheduler (только MySQL)';
        ...
        $strings['NoUpgradeNeeded'] = 'Нет необходимости обновления. Запуск процесса установки удалит все существующие данные и установить новую копию FMG Scheduler!';
        ...
        $strings['InstalledVersion'] = 'Сейчас у вас запущена версия %s FMG Scheduler';
        ...
        $strings['ConfigureApplication'] = 'Настроить FMG Scheduler';
