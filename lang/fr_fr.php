...
class fr_fr extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        // Install
        $strings['InstallApplication'] = 'Installer Hospitality Signage Platform (seulement avec MySQL)';
        ...
        $strings['InstalledVersion'] = 'Vous utilisez à présent la version %s de Hospitality Signage Platform';
        ...
        $strings['ConfigureApplication'] = 'Configurer Hospitality Signage Platform';
