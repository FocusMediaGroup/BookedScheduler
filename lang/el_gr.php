...
class el_gr extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        // Install
        $strings['InstallApplication'] = 'Εγκατάσταση του Hospitality Signage Platform (μόνο MySQL)';
        ...
        $strings['InstalledVersion'] = 'Εκτελείτε τώρα την έκδοση %s του Hospitality Signage Platform';
        ...
        $strings['ConfigureApplication'] = 'Παραμετροποίηση του Hospitality Signage Platform';
