...
class el_gr extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        // Install
        $strings['InstallApplication'] = 'Εγκατάσταση του FMG Scheduler (μόνο MySQL)';
        ...
        $strings['InstalledVersion'] = 'Εκτελείτε τώρα την έκδοση %s του FMG Scheduler';
        ...
        $strings['ConfigureApplication'] = 'Παραμετροποίηση του FMG Scheduler';
